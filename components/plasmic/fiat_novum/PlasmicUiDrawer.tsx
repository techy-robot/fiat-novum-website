...
export type PlasmicUiDrawer__VariantsArgs = {
  noTrigger?: SingleBooleanChoiceArg<"noTrigger">;
};
type VariantPropType = keyof PlasmicUiDrawer__VariantsArgs;
export const PlasmicUiDrawer__VariantProps = new Array<VariantPropType>(
  "noTrigger"
);

export type PlasmicUiDrawer__ArgsType = {
  isOpen?: boolean;
...
type ArgPropType = keyof PlasmicUiDrawer__ArgsType;
export const PlasmicUiDrawer__ArgProps = new Array<ArgPropType>(
  "isOpen",
...
export type PlasmicUiDrawer__OverridesType = {
...
export interface DefaultUiDrawerProps {
  isOpen?: boolean;
  closeOnBackdropClick?: boolean;
  showHeading?: boolean;
  showCancelButton?: boolean;
...
function PlasmicUiDrawer__RenderFunc(props: {
  variants: PlasmicUiDrawer__VariantsArgs;
  args: PlasmicUiDrawer__ArgsType;
  overrides: PlasmicUiDrawer__OverridesType;
  forNode?: string;
}) {
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_ZzZX5BZvPoOl"]]: true })}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <UiButton
                  className={classNames("__wab_instance", sty.uiButton__dgNBw)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicUiDrawer__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicUiDrawer__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicUiDrawer__ArgProps,
          internalVariantPropNames: PlasmicUiDrawer__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicUiDrawer__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "ariaDialogTrigger") {
    func.displayName = "PlasmicUiDrawer";
  } else {
    func.displayName = `PlasmicUiDrawer.${nodeName}`;
  }
  return func;
}

export const PlasmicUiDrawer = Object.assign(
  // Top-level PlasmicUiDrawer renders the root element
  makeNodeComponent("ariaDialogTrigger"),
  {
    ...
    // Metadata about props expected for PlasmicUiDrawer
    internalVariantProps: PlasmicUiDrawer__VariantProps,
    internalArgProps: PlasmicUiDrawer__ArgProps
  }
);

export default PlasmicUiDrawer;
/* prettier-ignore-end */
