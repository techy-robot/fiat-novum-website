...
import Button from "../../Button"; // plasmic-import: bCv3rmLWmiVO/component
import { BasePopover } from "@plasmicpkgs/react-aria/skinny/registerPopover";
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: rVclYcyj4wyh/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: VDfXZ58PVEHt/css
  ...
  return (
    <BaseDialogTrigger
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__ssWv6)}
            label={"Open Popover"}
          />
        ),
