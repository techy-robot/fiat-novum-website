...
import Checkbox from "../../Checkbox"; // plasmic-import: SLjAYqC_PtDM/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: H0bBbEhWDNXN/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__r9Rk7)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___3LDyI)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__rBAzW)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__befH1)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
