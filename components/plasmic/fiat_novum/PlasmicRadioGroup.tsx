...
import Radio from "../../Radio"; // plasmic-import: ZAJiHSGC0jt9/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: oWRW-fsruwmt/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__fr6D0)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__ztA8W)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__oV4Hu)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__gzdU)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
