...
function BlogPostLayout_(
  ...
  // Use PlasmicBlogPostLayout to render this component as it was
  ...
  //
  // By default, we are just piping all BlogPostLayoutProps here, but feel free
  // to do whatever works for you.

  return <PlasmicBlogPostLayout root={{ ref }} {...props} />;
}
