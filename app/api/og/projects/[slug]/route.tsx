...
export async function GET(request: NextRequest) {
  ...
  const displayTitle = project ? project.entry.title : 'FIAT NOVUM';
  const displaySummary = project ? project.entry.summary : 'Engineering & Design Portfolio';
